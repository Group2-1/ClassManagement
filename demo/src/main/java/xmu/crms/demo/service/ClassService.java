...
public interface ClassService {
     ...
     */
    List<xmu.crms.demo.entity.ClassInfo> listClassByName(String courseName, String teacherName) throws
	...
	void endCallRollById(Location location) throws SeminarNotFoundException, ClassesNotFoundException;
}
