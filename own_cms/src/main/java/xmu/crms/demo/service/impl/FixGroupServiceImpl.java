...
import xmu.crms.demo.dao.FixGroupDao;
...
public class FixGroupServiceImpl implements FixGroupService {
    ...
    @Override
    public BigInteger insertStudentIntoGroup(BigInteger userId, BigInteger groupId) throws IllegalArgumentException, FixGroupNotFoundException, UserNotFoundException, ClassesNotFoundException,InvalidOperationException {
    ...
    public FixGroup getFixedGroupById(BigInteger userId, BigInteger classId) throws IllegalArgumentException, ClassesNotFoundException, UserNotFoundException {
        ...
        if(classInfo == null){
            throw new ClassesNotFoundException("未找到固定小组的班级");
        }
