...
public class GroupController {
    ...
    @GetMapping("/{groupId}")
    public Object getGroup(@PathVariable("groupId") int groupId) {
    ...
    public Object removeMember(@PathVariable("groupId") int groupId, @RequestBody User user, HttpServletResponse response) {
    ...
    public Object updateGroupReportGrade(@PathVariable("groupId") int groupId, @RequestBody SeminarGrade grade, HttpServletResponse response) {
    ...
    public Object updateGroupPresentationGrade(@PathVariable("groupId") int groupId, @PathVariable("studentId") int studentId, @RequestBody SeminarGrade grade, HttpServletResponse response) {
